...
export namespace Request {
    ...
    export class PublishAction extends jspb.Message {
        ...
        addEvents(
            value?: clientchannel_event_pb.EventEnvelope,
            index?: number
        ): clientchannel_event_pb.EventEnvelope;
    ...
    export class InvalidateGdprAction extends jspb.Message {
        ...
        static toObject(
            ...
            msg: InvalidateGdprAction
        ): InvalidateGdprAction.AsObject;
        static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
        static extensionsBinary: { [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message> };
